...
export const translations: Record<Locale, Record<TranslationKey, string>> = {
    en: {
        ...
        avatar_user: 'Driver',
        // Landing Page
        navPracticeNow: 'Practice Now',
        logIn: 'Log In',
        heroTitle: 'Pass Your CDL Permit Test.\nFirst Time.',
        heroSubtitle: 'CDL practice tests based on the 2025 official manual. Class A, Class B, Air Brakes, and more.',
        heroCta: 'Start Free Trial',
        heroTrust: '50 free questions to get started • Upgrade anytime',
        statActiveUsers: 'Questions',
        statStatesCovered: 'Florida Only',
        statUpdatedQA: 'Updated Q&A',
        featuresTitle: 'Why CDL Zero?',
        featuresSubtitle: 'Everything you need to ace the exam.',
        feature1Title: 'Official Manual Based',
        feature1Desc: 'Questions are identical to the real ones, derived directly from your state\'s CDL handbook.',
        feature2Title: 'Exam Mode Simulator',
        feature2Desc: 'Practice under time pressure with the same structure as the actual DMV test.',
        feature3Title: 'Smart Analytics',
        feature3Desc: 'We track your weak spots and automatically suggest topics to review.',
        ctaStripTitle: 'Ready to get on the road?',
        ctaStripSubtitle: 'Join thousands of drivers passing their permit test today.',
        ctaStripButton: 'Start Practice Test',
        footerTagline: 'Your #1 partner for passing the CDL exam.',
    ...
    es: {
        ...
        // Landing Page
        navPracticeNow: 'Practicar Ahora',
        logIn: 'Iniciar Sesión',
        heroTitle: 'Aprueba tu examen CDL.\nA la primera.',
        heroSubtitle: 'Pruebas de práctica CDL basadas en el manual oficial 2025. Clase A, Clase B, Frenos de Aire y más.',
        heroCta: 'Comenzar Prueba Gratis',
        heroTrust: '50 preguntas gratis para comenzar • Actualiza cuando quieras',
        statActiveUsers: 'Preguntas',
        statStatesCovered: 'Solo Florida',
        statUpdatedQA: 'Preguntas Actualizadas',
        featuresTitle: '¿Por qué CDL Zero?',
        featuresSubtitle: 'Todo lo que necesitas para aprobar el examen.',
        feature1Title: 'Basado en el Manual Oficial',
        feature1Desc: 'Las preguntas son idénticas a las reales, derivadas directamente del manual CDL de tu estado.',
        feature2Title: 'Simulador de Examen',
        feature2Desc: 'Practica bajo presión de tiempo con la misma estructura que la prueba real del DMV.',
        feature3Title: 'Analítica Inteligente',
        feature3Desc: 'Rastreamos tus puntos débiles y sugerimos automáticamente temas para repasar.',
        ctaStripTitle: '¿Listo para salir a la carretera?',
        ctaStripSubtitle: 'Únete a miles de conductores que aprueban su examen de permiso hoy.',
        ctaStripButton: 'Iniciar Prueba de Práctica',
        footerTagline: 'Tu socio #1 para aprobar el examen CDL.',
    ...
    ru: {
        ...
        // Landing Page
        navPracticeNow: 'Практика',
        logIn: 'Войти',
        heroTitle: 'Сдайте экзамен CDL.\nС первого раза.',
        heroSubtitle: 'Тесты CDL на основе официального руководства 2025 года. Класс A, Класс B, Пневмотормоза и другое.',
        heroCta: 'Начать бесплатную пробную версию',
        heroTrust: '50 бесплатных вопросов для начала • Обновите в любое время',
        statActiveUsers: 'Вопросов',
        statStatesCovered: 'Только Флорида',
        statUpdatedQA: 'Обновленные вопросы',
        featuresTitle: 'Почему CDL Zero?',
        featuresSubtitle: 'Все, что нужно для сдачи экзамена.',
        feature1Title: 'На основе официального руководства',
        feature1Desc: 'Вопросы идентичны реальным, взяты непосредственно из справочника CDL вашего штата.',
        feature2Title: 'Симулятор экзамена',
        feature2Desc: 'Практикуйтесь под давлением времени с той же структурой, что и на реальном тесте DMV.',
        feature3Title: 'Умная аналитика',
        feature3Desc: 'Мы отслеживаем ваши слабые места и автоматически предлагаем темы для повторения.',
        ctaStripTitle: 'Готовы к дороге?',
        ctaStripSubtitle: 'Присоединяйтесь к тысячам водителей, сдающих экзамен уже сегодня.',
        ctaStripButton: 'Начать тест',
        footerTagline: 'Ваш партнер №1 для сдачи экзамена CDL.',
