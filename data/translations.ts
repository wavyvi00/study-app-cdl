...
export const translations: Record<Locale, Record<TranslationKey, string>> = {
    en: {
        ...
        heroSubtitle: '100% Free CDL practice tests based on the 2025 official manual. Class A, Class B, Air Brakes, and more.',
        heroCta: 'Start Your Free Practice',
        heroTrust: 'No credit card required. No hidden fees.',
        ...
        footerTagline: 'Your #1 partner for passing the CDL exam. 100% Free.',
    ...
    es: {
        ...
        heroSubtitle: 'Pruebas de práctica CDL 100% gratuitas basadas en el manual oficial 2025. Clase A, Clase B, Frenos de Aire y más.',
        heroCta: 'Comienza tu Práctica Gratis',
        heroTrust: 'No se requiere tarjeta de crédito. Sin cargos ocultos.',
        statActiveUsers: 'Usuarios Activos',
        statStatesCovered: 'Estados Cubiertos',
        ...
        footerTagline: 'Tu socio #1 para aprobar el examen CDL. 100% Gratis.',
    ...
    ru: {
        ...
        heroSubtitle: '100% бесплатные тесты CDL на основе официального руководства 2025 года. Класс A, Класс B, Пневмотормоза и другое.',
        heroCta: 'Начать бесплатно',
        heroTrust: 'Кредитная карта не требуется. Никаких скрытых комиссий.',
        statActiveUsers: 'Активных пользователей',
        statStatesCovered: 'Штатов покрыто',
        ...
        footerTagline: 'Ваш партнер №1 для сдачи экзамена CDL. 100% Бесплатно.',
